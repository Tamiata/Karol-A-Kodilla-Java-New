...
//    Celem zadania jest obliczenie średniej liczby dni, jaka upłynęła od zlecenia wykonania zadania do dnia bieżącego w liście zadań, które są aktualnie w trakcie realizacji. Do jego wykonania można użyć dwóch strumieni – jeden aby obliczyć sumę, a drugi, aby obliczyć liczbę elementów. Lub w wersji trudniejszej – należy wykorzystać kolektor skalarny average().
//
